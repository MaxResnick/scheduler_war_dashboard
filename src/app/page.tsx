    ...
    <div className="mx-auto flex w-full max-w-7xl flex-col gap-8 px-6 py-8">
      <header className="space-y-2">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <h1 className="text-3xl font-semibold">Validator Slot Time Rankings</h1>
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              href="/prop-amm-comparison"
              className="rounded-lg bg-slate-800 px-4 py-2 text-sm font-medium text-slate-200 transition-colors hover:bg-slate-700"
            >
              Prop AMM Compare →
            </Link>
            <Link
              href="/prop-amm-winrates"
              className="rounded-lg bg-slate-800 px-4 py-2 text-sm font-medium text-slate-200 transition-colors hover:bg-slate-700"
            >
              Oracle Win Rates →
            </Link>
        ...
        <p className="max-w-2xl text-sm text-slate-300">
          ...
          Slower validators at the top. Uses 4-hour window.
        </p>
      </header>

      <ValidatorSlotsChart validators={validators} />
    </div>
  );
}
